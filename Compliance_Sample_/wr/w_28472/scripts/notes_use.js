...
function resizeIFrame(){  
	...
	defaultIframe();
	setTimeout(function(){lCurrentWidgetIframe.parentElement.style.top = iframeTop;lCurrentWidgetIframe.parentElement.style.left = iframeLeft;canvas.parentElement.style.visibility = "visible";},55);
}
