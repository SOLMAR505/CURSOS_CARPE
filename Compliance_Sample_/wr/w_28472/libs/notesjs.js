...
(lib.toolTips_mc = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text(ID_Clicktoaddanote, "13px Arial");
	this.text.textAlign = "center";
	this.text.lineHeight = 15;
	this.text.lineWidth = 116;
	this.text.setTransform(19.4,-24.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.text,p:{regX:59.8,x:79.3,text:ID_Clicktoaddanote,lineWidth:116}}]},1).to({state:[{t:this.text,p:{regX:59.6,x:79.025,text:ID_Clicktohidenote,lineWidth:115}}]},1).to({state:[{t:this.text,p:{regX:59.6,x:79.025,text:ID_Clicktoshownote,lineWidth:115}}]},1).wait(1));
...
(lib.noteicon = function() {
	...
	// Layer 1
	console.log(ID_Note)
	this.text_1 = new cjs.Text(ID_Note, ID_Note_Size, "#333333");
